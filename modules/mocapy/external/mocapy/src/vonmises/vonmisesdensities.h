...
public:
	...
	// VonMises specific
	const std::vector<double> & get_mus() {return mus;}
	const std::vector<double> & get_kappas() {return kappas;}

	void set_mus(std::vector<double> user_mus);
	void set_kappas(std::vector<double> user_kappas);

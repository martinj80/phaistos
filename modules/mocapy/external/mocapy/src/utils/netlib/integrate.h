...
double integrate_quad(double(*func)(double *), double a, double b, int *evaluations=NULL,
                      double epsabs=1.49e-8, double epsrel=1.49e-8, int limit=50);


// Version of quad taking additional arguments of type double
double integrate_quad(double(*func)(double *, double *), double extra_arguments[], double a, double b,
